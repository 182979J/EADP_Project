...
namespace MyProject.SMSSvrRef {
    ...
    public interface SMSSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        MyProject.SMSSvrRef.SMSData[] receiveMessage(string SMSAccount, string SMSPassword);
        
        [System.ServiceModel.OperationContractAttribute(Action="WS/receiveMessage", ReplyAction="*")]
        System.Threading.Tasks.Task<MyProject.SMSSvrRef.SMSData[]> receiveMessageAsync(string SMSAccount, string SMSPassword);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SMSSoapChannel : MyProject.SMSSvrRef.SMSSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SMSSoapClient : System.ServiceModel.ClientBase<MyProject.SMSSvrRef.SMSSoap>, MyProject.SMSSvrRef.SMSSoap {
        ...
        public MyProject.SMSSvrRef.SMSData[] receiveMessage(string SMSAccount, string SMSPassword) {
            return base.Channel.receiveMessage(SMSAccount, SMSPassword);
        }
        
        public System.Threading.Tasks.Task<MyProject.SMSSvrRef.SMSData[]> receiveMessageAsync(string SMSAccount, string SMSPassword) {
